...
장바구니가 없을 때 상품을 담기
    ...
    3. Cart 엔터티의 Cart id와 CartProduct 엔터티의 Cart id가 동일해야 합니다.
    4. CartProduct 엔터티의 상품 아이디와 Product 엔터티의 상품 아이디가 동일해야 합니다.

장바구니가 있을 때 상품을 담기
    1. Cart 엔터티에 변동 사항 없습니다.
    2. CartProduct 엔터티에 신규 상품 정보만 추가됩니다.
*/

@RestController
@RequestMapping("/cart")
@RequiredArgsConstructor // final 키워드를 가지고 있는 필드에 생성자를 이용하여 자동으로 주입해주니다.
